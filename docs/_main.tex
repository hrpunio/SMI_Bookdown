...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    78.0    96.0   102.5   102.5   109.0   126.5
\end{verbatim}

średnia (średnich z próby) ma wartość 102.47
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    89.0    99.8   102.7   102.6   105.5   115.7
\end{verbatim}

średnia wyszła 102.61 a odchylenie standardowe
4.24.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    96.6   101.5   102.8   102.8   104.1   110.7
\end{verbatim}

średnia jest równa 102.76 a odchylenie standardowe 1.97.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   19.50   38.50   46.00   46.08   53.50   79.50
\end{verbatim}

Średnia średnich z próby ma wartość 46.08 lat.
Odchylenie standardowe wyniosło 10.55.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   31.40   43.10   46.30   46.26   49.40   59.50
\end{verbatim}

Średnia średnich z próby ma wartość 46.26 lat.
Odchylenie standardowe wyniosło 4.58.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   39.52   44.65   46.26   46.22   47.77   54.50
\end{verbatim}

Średnia średnich z próby ma wartość 46.22 lat.
Odchylenie standardowe wyniosło 2.2656871.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   40.59   45.13   46.23   46.24   47.37   52.41
\end{verbatim}

Średnia średnich z próby ma wartość 46.24 lat.
Odchylenie standardowe wyniosło 1.702523
