...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    74.0    95.5   102.0   102.1   109.0   130.0
\end{verbatim}

średnia (średnich z próby) ma wartość 102.13
a odchylenie standardowe 9.28.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    89.3    99.7   102.7   102.5   105.4   116.5
\end{verbatim}

średnia wyszła 102.47 a odchylenie standardowe
4.09.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   96.38  101.45  102.81  102.84  104.23  110.00
\end{verbatim}

średnia jest równa 102.84 a odchylenie standardowe 2.04.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   19.00   38.50   46.00   46.19   54.00   73.00
\end{verbatim}

Średnia średnich z próby ma wartość 46.19 lat.
Odchylenie standardowe wyniosło 10.62.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   30.30   43.10   46.20   46.28   49.40   62.70
\end{verbatim}

Średnia średnich z próby ma wartość 46.28 lat.
Odchylenie standardowe wyniosło 4.66.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   39.00   44.74   46.27   46.23   47.76   53.27
\end{verbatim}

Średnia średnich z próby ma wartość 46.23 lat.
Odchylenie standardowe wyniosło 2.2729681.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   40.83   45.09   46.24   46.23   47.30   52.99
\end{verbatim}

Średnia średnich z próby ma wartość 46.23 lat.
Odchylenie standardowe wyniosło 1.6966764
...
\subsection{Zmienna liczbowa i zmienne liczbowe lub nominalne}\label{zmienna-liczbowa-i-zmienne-liczbowe-lub-nominalne}}
...
temat szkodliwości palenia papierosów} (promotor: dr Marzeny Barton);
Kwidzyn 2022.
