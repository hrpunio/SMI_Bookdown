...
\textbf{Przykład}: chcemy ustalić czy spożywanie kawy w czasie sesji egzaminacyjnej
...
Rysunek przedstawia zależność pomiędzy wynikiem (\emph{outcome}), przyczyną
...
\textbf{Przykład}: badamy grupę pacjentów przychodni onkologicznej. Stwierdzamy że 90\% z nich paliło
...
\textbf{Przykład 1: Czy konsumpcja soli kuchennej szkodzi? (eksperyment)}
...
\textbf{Przykład 2: Konflikt praca-dom w zawodzie pielęgniarki (przekrojowe)}
...
\textbf{Przykład 1}: Tablica dla cechy niemierzalnej (nominalnej albo porządkowej)

Absolwenci studiów pielęgniarskich w ośmiu największych
krajach UE w roku 2018

\textbf{Jednostka badania}: absolwent studiów pielęgniarskich w roku 2018,

\textbf{Badana cecha}: kraj w którym ukończył studia (nominalna)
...
\textbf{Przykład 2}: Tablica dla cechy mierzalnej (liczbowej; skokowej lub ciągłej)
...
\item
  ...
  były \textbf{otwarte}, tj. nie miały dolnej (pierwszy) lub górnej
  (ostatni) \textbf{granicy}
\end{itemize}
...
\textbf{Przykład}: Dzietność kobiet na świecie
...
\includegraphics{./FN_diagram.jpg}
...
\textbf{Przykład: współczynnik dzietności na świecie w roku 2018}
...
\textbf{Przykład}: współczynnik dzietności na świecie w roku 2018 (cd)
...
\textbf{Przykład: masa ciała uczestników Pucharu Świata w Rugby}
...
\hypertarget{przykux142adowy-problem-nr-1}{%
\section{Przykładowy problem nr 1}\label{przykux142adowy-problem-nr-1}}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    79.5    97.0   103.0   103.2   109.5   133.5
\end{verbatim}

średnia (średnich z próby) ma wartość 103.17
a odchylenie standardowe 9.03.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    89.9   100.1   102.8   102.8   105.6   115.3
\end{verbatim}

średnia wyszła 102.78 a odchylenie standardowe
4.02.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   96.88  101.27  102.65  102.65  104.20  109.38
\end{verbatim}

średnia jest równa 102.65 a odchylenie standardowe 2.15.
...
\hypertarget{przykux142adowy-problem-nr-2}{%
\section{Przykładowy problem nr 2}\label{przykux142adowy-problem-nr-2}}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   20.00   39.50   46.50   46.52   54.00   77.50
\end{verbatim}

Średnia średnich z próby ma wartość 46.52 lat.
Odchylenie standardowe wyniosło 10.3.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   30.70   42.90   46.35   46.23   49.33   59.20
\end{verbatim}

Średnia średnich z próby ma wartość 46.23 lat.
Odchylenie standardowe wyniosło 4.72.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   38.85   44.70   46.30   46.31   47.85   54.10
\end{verbatim}

Średnia średnich z próby ma wartość 46.31 lat.
Odchylenie standardowe wyniosło 2.3365597.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   41.16   45.24   46.37   46.38   47.54   53.06
\end{verbatim}

Średnia średnich z próby ma wartość 46.38 lat.
Odchylenie standardowe wyniosło 1.7595065
...
\textbf{Przykład: szacowanie odsetka kobiet}
...
\includegraphics{./DiagramMetod.png}
...
\textbf{Przykład: Podawanie witaminy C a przeziębienie/brak przeziębienia}
...
\textbf{Przykład: Narciarze Paulinga cd}
...
\textbf{Przykład: Narciarze Paulinga jeszcze raz}
...
\textbf{Przykład: palenie a status społeczno-ekonomiczny}
...
\textbf{Przykład}: Poziom depresji a miejsce pracy
...
\textbf{Przykład: Poziom depresji a staż pracy}
...
\textbf{Przykład: Zależność pomiędzy zamożnością a spożyciem mięsa}
...
\textbf{Przykład: korelacja między spożyciem mięsa a GDP}
...
\textbf{Przykład: korelacja pomiędzy wiekiem, edukacją, szczęściem a stanem zdrowia}
...
Graficznie \textbf{kryterium minimalizacyjne} przedstawia rysunek

\includegraphics[width=0.75\textwidth,height=\textheight]{./kmnk_roznice.png}
...
\textbf{Przykład: Waga a wzrost rugbystów}
...
\hline
(Intercept) & 157.1485718 & 2.1297673 & 73.78673 & 0 & 152.970000--161.330000\\
\hline
weight & 0.2808207 & 0.0206739 & 13.58336 & 0 & 0.240000--0.320000\\
\hline
\end{tabular}
...
\textbf{Przykład: zamożność a konsumpcja mięsa}

Następujący równanie opisuje zależność pomiędzy dochodem narodowym na głowę (\emph{per capita})
...
Każdy USD \emph{per capita} więcej dochodu narodowego (GDP) oznacza przeciętny
...
0.0011075) jest statystycznie istotny.
...
\textbf{Przykład: zależność pomiędzy ciśnienie skurczowym, BMI oraz wiekiem}
...
\textbf{Przykład: zależność pomiędzy ciśnienie skurczowym, BMI, wiekiem, płcią, paleniem i piciem}
...
\textbf{Przykład: regresja krokowa}
...
\textbf{Przykład \#1: Osteoporoza i witamina D}
...
\includegraphics{_main_files/figure-latex/unnamed-chunk-98-1.pdf} \includegraphics{_main_files/figure-latex/unnamed-chunk-98-2.pdf} \includegraphics{_main_files/figure-latex/unnamed-chunk-98-3.pdf}
