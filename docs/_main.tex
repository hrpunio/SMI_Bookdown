...
Średnia (średnich z próby) ma wartość \text{102,61} kilogramów
a odchylenie standardowe \text{9,06} kilogramów.
...
w eksperymencie (\text{9,06} vs \text{9,14}).

Zauważmy też, że wartość najniższej średniej wyniosła \text{80} kilogramów zaś najwyższej \text{132} kilogramów.
Gdybyśmy mieli pecha i wylosowali te skrajnie nieprawdziwe wartości to mylimy się
o \text{22,61} kilogramów
na minus lub \text{29,39} kilogramów na plus.
...
Średnia ma wartość \text{102,63} kilogramów, a odchylenie standardowe
\text{3,84} kilogramów.
...
Średnia jest równa \text{102,75} kilogramów, a odchylenie standardowe \text{1,98} kilogramów.
Wartość \(s/\sqrt{40}\) jest równa \text{2,04}.

Zauważmy też, że wartość najniższej średniej wyniosła \text{95,75} kilogramów zaś najwyższej \text{108,525} kilogramów.
Gdybyśmy mieli pecha i wylosowali te skrajnie nieprawdziwe wartości to mylimy się o \text{7} kilogramów
na minus lub \text{5,78} kilogramów na plus. Niewątpliwie wynik znacznie lepszy niż dla próby
dwuelementowej.
...
Odchylenie standardowe wyniosło \text{10,55}.
Wartość \(s/\sqrt{2}\) jest równa \text{10,33}.

Wartość najniższej średniej wyniosła \text{18,5} lat zaś najwyższej \text{76,5} lat.
Gdybyśmy mieli pecha i wylosowali te skrajnie nieprawdziwe wartości to mylimy się
o \text{27,65} lat
na minus lub \text{30,35} lat na plus.
...
Średnia średnich z próby ma wartość \text{46,16} lat.
Odchylenie standardowe wyniosło \text{4,48}.
...
Odchylenie standardowe wyniosło \text{2,34}.
...
Odchylenie standardowe wyniosło \text{1,82}
Wartość \(s/\sqrt{70}\) jest równa \text{1,75}.

Wartość najniższej średniej wyniosła \text{38,79} lat zaś najwyższej \text{51,31} lat.
Gdybyśmy mieli pecha i wylosowali te skrajnie nieprawdziwe wartości to mylimy się
już tylko o \text{7,5} lat
na minus lub \text{5,02} lat na plus.
