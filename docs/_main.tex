...
Carl Pearson (korelacja, test niezależności chi-kwadrat) oraz Ronald Fisher (podstawy wnioskowania).
...
zwanego \textbf{współczynnikiem korelacji liniowej}, (\emph{linear
