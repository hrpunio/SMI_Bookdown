...
Krajów jest 201. Wartość minimalna wynosi 1.22 a wartość
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{./neg_posit_screw} \caption{Rozkłady symetryczne i asymetryczne}\label{fig:skeweness}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{./boxPlotExample} \caption{Wykres pudełkowy}\label{fig:boxplot}
\end{figure}
...
\chapter{Łagodne wprowadzenie do wnioskowania statystycznego}\label{interference}}
...
Średnia (średnich z próby) ma wartość 103.11 kilogramów
a odchylenie standardowe 8.71 kilogramów.
...
Zauważmy też że wartość najniższej średniej wyniosła 77 kilogramów zaś najwyższej 131 kilogramów.
Gdybyśmy mieli pecha i wylosowali te skrajnie nieprawdziwe wartości to mylimy się
o 26.11 kilogramów
na minus lub 27.89 kilogramów na plus.
...
średnia wyszła 102.81 kilogramów a odchylenie standardowe
4.07 kilogramów.
...
średnia jest równa 102.78 kilogramów a odchylenie standardowe 1.99 kilogramów.
Wartość \(s/\sqrt{40}\) jest równa 2.04.

Zauważmy też że wartość najniższej średniej wyniosła 97.05 kilogramów zaś najwyższej 109.75 kilogramów.
Gdybyśmy mieli pecha i wylosowali te skrajnie nieprawdziwe wartości to mylimy się o 5.73 kilogramów
na minus lub 6.97 kilogramów na plus. Niewątpliwie wynik znacznie lepszy niż dla próby
dwuelementowej.
...
Wartość najniższej średniej wyniosła 19 lat zaś najwyższej 75.5 lat.
Gdybyśmy mieli pecha i wylosowali te skrajnie nieprawdziwe wartości to mylimy się
o 27.07 lat
na minus lub 29.43 lat na plus.
...
Odchylenie standardowe wyniosło 2.22.
Wartość \(s/\sqrt{40}\) jest równa 2.31.
...
Odchylenie standardowe wyniosło 1.7
Wartość \(s/\sqrt{70}\) jest równa 1.75.

Wartość najniższej średniej wyniosła 40.23 lat zaś najwyższej 52.53 lat.
Gdybyśmy mieli pecha i wylosowali te skrajnie nieprawdziwe wartości to mylimy się
już tylko o 6.03 lat
na minus lub 6.27 lat na plus.
...
Analizując dane uzyskane z próby celem jest ich \textbf{uogólnienie} na całą populację. To uogólnienie
...
\textbf{wariancją błędu} albo \emph{error variance}).
...
\begin{figure}
\includegraphics[width=0.75\linewidth]{./TestFlowChart} \caption{Testowanie istotności różnicy pomiędzy średnimi}\label{fig:testy}
\end{figure}
...
\includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-49-1}
...
\includegraphics[width=0.75\linewidth]{_main_files/figure-latex/unnamed-chunk-52-1}
...
\texttt{PS} (\emph{past smoker}/kiedyś palił) = 1 jeżeli palił ale nie pali, 0 w przeciwnym przypadku
...
CS & -6.890 & 3.972 & -1.735 & 0.087 & -0.180 & -14.790 1.010\\
\addlinespace
PS & 7.626 & 6.882 & 1.108 & 0.271 & 0.110 & -6.070 21.320\\
CD & -3.959 & 8.523 & -0.465 & 0.643 & -0.040 & -20.910 13.000\\
PD & -4.001 & 4.575 & -0.875 & 0.384 & -0.080 & -13.100 5.100\\
\bottomrule
\end{tabular}
...
CS & -2.752 & 0.583 & -4.717 & 0.000 & -0.070 & -3.900 -1.610\\
\addlinespace
PS & -2.021 & 1.045 & -1.933 & 0.053 & -0.030 & -4.070 0.030\\
CD & 3.621 & 1.535 & 2.360 & 0.018 & 0.030 & 0.610 6.630\\
PD & 0.193 & 0.623 & 0.310 & 0.757 & 0.000 & -1.030 1.410\\
\bottomrule
\end{tabular}
...
CS & -2.740 & 0.582 & -4.708 & 0.000 & -0.070 & -3.880 -1.600\\
\addlinespace
PS & -1.980 & 1.037 & -1.910 & 0.056 & -0.030 & -4.010 0.050\\
CD & 3.579 & 1.528 & 2.342 & 0.019 & 0.030 & 0.580 6.580\\
\bottomrule
\end{tabular}
...
CS & -2.540 & 0.573 & -4.435 & 0.00 & -0.060 & -3.660 -1.420\\
\addlinespace
CD & 3.551 & 1.529 & 2.323 & 0.02 & 0.030 & 0.550 6.550\\
\bottomrule
\end{tabular}
...
\includegraphics[width=0.75\linewidth]{_main_files/figure-latex/unnamed-chunk-68-1}
...
\includegraphics[width=0.75\linewidth]{_main_files/figure-latex/unnamed-chunk-74-1}
\end{example}
...
Przejście od definicji koncepcyjnej do definicji operacyjnej bywa czasami mocno, hmm\ldots{} arbitralne.
...
\includegraphics[width=0.7\linewidth]{_main_files/figure-latex/unnamed-chunk-77-1}
...
\includegraphics[width=0.7\linewidth]{_main_files/figure-latex/unnamed-chunk-78-1}

Rozkład ankietowanych ze względu na płeć przedstawiono na rysunku

\includegraphics[width=0.7\linewidth,height=0.3\textheight]{_main_files/figure-latex/unnamed-chunk-79-1}

Rozkład ankietowanych ze względu na staż pracy przedstawiono na rysunku

\includegraphics[width=0.7\linewidth]{_main_files/figure-latex/unnamed-chunk-80-1}

Rozkład ankietowanych ze względu na rodzaj miejsca pracy
przedstawiono na rysunku

\includegraphics[width=0.7\linewidth]{_main_files/figure-latex/unnamed-chunk-81-1}
...
\includegraphics[width=0.7\linewidth]{_main_files/figure-latex/unnamed-chunk-93-1}

Rozkład ankietowanych ze względu na płeć przedstawiono na rysunku.

\includegraphics[width=0.7\linewidth,height=0.3\textheight]{_main_files/figure-latex/unnamed-chunk-94-1}

Rozkład ankietowanych ze względu na staż przedstawiono na rysunku.

\includegraphics[width=0.7\linewidth]{_main_files/figure-latex/unnamed-chunk-95-1}

\hypertarget{weryfikacja-hipotezy-1-1}{%
\subsection{Weryfikacja hipotezy 1}\label{weryfikacja-hipotezy-1-1}}

\includegraphics[width=0.7\linewidth]{_main_files/figure-latex/unnamed-chunk-96-1}
...
\includegraphics[width=0.7\linewidth]{_main_files/figure-latex/unnamed-chunk-108-1}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./Jamovi_data_import} \caption{Import danych}\label{fig:dataimport}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./przeksztalcenie_0} \caption{Przekształcenie}\label{fig:przeksztalcenie0}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./przeksztalcenie_1} \caption{Przekształcenie}\label{fig:przeksztalcenie1}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./przeksztalcenie_1p} \caption{Przekształcenie}\label{fig:przeksztalcenie1p}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./przeksztalcenie_3} \caption{Przekształcenie}\label{fig:przeksztalcenie3}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./przeksztalcenie_4} \caption{Przekształcenie}\label{fig:przeksztalcenie4}
\end{figure}

\begin{figure}
\includegraphics[width=0.95\linewidth]{./przeksztalcenie_contains} \caption{Przekształcenie}\label{fig:przeksztalcenieContains}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./zmienna_satysfakcja} \caption{Obliczanie nowej zmiennej}\label{fig:zmiennaSatysfakcja}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./statystyki_opisowe_okno} \caption{Statystyki opisowe}\label{fig:statystykiOpisoweOkno}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./statystyki_opisowe_wynik} \caption{Statystyki opisowe}\label{fig:statystykiSpisoweWynik}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./tabele_krzyzowe} \caption{Tabele krzyżowe}\label{fig:tabeleKrzyzowe}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./testy} \caption{Test dla prób niezależnych}\label{fig:testyJamovi}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./regresja_liniowa} \caption{Regresja liniowa}\label{fig:regresjaLiniowa}
\end{figure}
