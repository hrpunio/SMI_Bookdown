...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    79.5    96.5   103.5   103.3   110.0   135.0
\end{verbatim}

średnia (średnich z próby) ma wartość 103.33
a odchylenie standardowe 9.24.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    91.4   100.2   102.6   102.7   105.3   114.4
\end{verbatim}

średnia wyszła 102.74 a odchylenie standardowe
3.95.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   96.17  101.34  102.75  102.80  104.20  111.25
\end{verbatim}

średnia jest równa 102.8 a odchylenie standardowe 2.08.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   20.50   39.00   46.50   46.32   54.00   74.00
\end{verbatim}

Średnia średnich z próby ma wartość 46.32 lat.
Odchylenie standardowe wyniosło 10.79.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   34.90   43.17   46.30   46.39   49.40   60.30
\end{verbatim}

Średnia średnich z próby ma wartość 46.39 lat.
Odchylenie standardowe wyniosło 4.69.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   38.82   44.58   46.12   46.08   47.58   52.25
\end{verbatim}

Średnia średnich z próby ma wartość 46.08 lat.
Odchylenie standardowe wyniosło 2.2611867.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   41.14   45.05   46.34   46.28   47.47   51.40
\end{verbatim}

Średnia średnich z próby ma wartość 46.28 lat.
Odchylenie standardowe wyniosło 1.7227446
...
nie ma wartości standaryzowanej (oznaczone jako \texttt{NA} czyli \emph{not available}),
...
z 95\% prawdopodobieństwem znajdujesię w przedziale {[}0.290 0.350{]}
