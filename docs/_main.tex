...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    78,5    96,5   103,0   103,0   109,5   130,5
\end{verbatim}

Średnia (średnich z próby) ma wartość \text{102,96} kilogramów
a odchylenie standardowe \text{9,07} kilogramów.
...
w eksperymencie (\text{9,07} vs \text{9,14}).

Zauważmy też, że wartość najniższej średniej wyniosła \text{78,5} kilogramów zaś najwyższej \text{130,5} kilogramów.
Gdybyśmy mieli pecha i wylosowali te skrajnie nieprawdziwe wartości to mylimy się
o \text{24,46} kilogramów
na minus lub \text{27,54} kilogramów na plus.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    84,5   100,0   102,6   102,6   105,4   114,6
\end{verbatim}

Średnia ma wartość \text{102,65} kilogramów, a odchylenie standardowe
\text{4,01} kilogramów.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   96,03  101,40  102,78  102,77  104,17  110,25
\end{verbatim}

Średnia jest równa \text{102,77} kilogramów, a odchylenie standardowe \text{2,04} kilogramów.
Wartość \(s/\sqrt{40}\) jest równa \text{2,04}.

Zauważmy też, że wartość najniższej średniej wyniosła \text{96,025} kilogramów zaś najwyższej \text{110,25} kilogramów.
Gdybyśmy mieli pecha i wylosowali te skrajnie nieprawdziwe wartości to mylimy się o \text{6,74} kilogramów
na minus lub \text{7,48} kilogramów na plus. Niewątpliwie wynik znacznie lepszy niż dla próby
dwuelementowej.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   20,50   37,88   45,00   45,40   52,50   76,50
\end{verbatim}

Średnia średnich z próby ma wartość \text{45,4} lat.
Odchylenie standardowe wyniosło \text{10,46}.
Wartość \(s/\sqrt{2}\) jest równa \text{10,33}.

Wartość najniższej średniej wyniosła \text{20,5} lat zaś najwyższej \text{76,5} lat.
Gdybyśmy mieli pecha i wylosowali te skrajnie nieprawdziwe wartości to mylimy się
o \text{24,9} lat
na minus lub \text{31,1} lat na plus.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   30,30   43,20   46,30   46,34   49,30   59,10
\end{verbatim}

Średnia średnich z próby ma wartość \text{46,34} lat.
Odchylenie standardowe wyniosło \text{4,65}.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   39,65   44,75   46,38   46,36   48,03   53,20
\end{verbatim}

Średnia średnich z próby ma wartość \text{46,36} lat.
Odchylenie standardowe wyniosło \text{2,32}.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   40,91   45,05   46,23   46,24   47,41   51,84
\end{verbatim}

Średnia średnich z próby ma wartość \text{46,24} lat.
Odchylenie standardowe wyniosło \text{1,79}
Wartość \(s/\sqrt{70}\) jest równa \text{1,75}.

Wartość najniższej średniej wyniosła \text{40,91} lat zaś najwyższej \text{51,84} lat.
Gdybyśmy mieli pecha i wylosowali te skrajnie nieprawdziwe wartości to mylimy się
już tylko o \text{5,32} lat
na minus lub \text{5,61} lat na plus.
