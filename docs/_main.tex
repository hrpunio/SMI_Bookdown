...
\includegraphics[width=0.7\linewidth]{_main_files/figure-latex/unnamed-chunk-84-1}
...
\includegraphics[width=0.7\linewidth]{_main_files/figure-latex/unnamed-chunk-99-1}
...
Zamiar zmiany pracy (ZZP), satysfakcja z pracy (SP)
...
\textbf{Satysfakcja z pracy/alternatywna skala}
...
\textbf{Satysfakcja z wynagrodzenia}
...
\textbf{Konflikt ze współpracownikami}
...
\textbf{Przywiązanie do ogranizacji} (\texttt{PO-1}--\texttt{PO-18}), składające się z następujących aspektów:
...
\textbf{Satysfakcja z pracy} (skala jednopozycyjna)
...
\textbf{Zamiar odejścia z pracy} (skala jednopozycyjna)
