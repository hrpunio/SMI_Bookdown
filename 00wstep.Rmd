...
swoim studentom. Byłem tym faktem tym bardziej zdziwiony, że wiedziałem
już wtedy,
...
nienadająca się do polecenia jej komukolwiek, kto chciałby się
nauczyć statystyki.
...
wcale aż taka trudna. Teoretycznie oznaczałoby to,
że część matematyczna powinna być zredukowana do absolutnego minimum,
...
rozumieć konkretny program komputerowy i niekoniecznie musi nim być
arkusz kalkulacyjny.
...
jest istotą wielu procedur statystycznych, takich jak np.
testy istotności.
...
się pod adresem:
[hrpunio.github.io/SMI_Bookdown/wstęp.html](https://hrpunio.github.io/SMI_Bookdown/wstęp.html).
Wykorzystane
w omawianych w książce przykładach zbiory danych można znaleźć
pod adresem: [github.com/hrpunio/SMBook](https://github.com/hrpunio/SMBook).
