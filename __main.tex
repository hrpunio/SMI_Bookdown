...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    76,0    96,0   103,5   103,0   109,5   131,0
\end{verbatim}

Średnia (średnich z próby) ma wartość \text{102,97} kilogramów
a odchylenie standardowe \text{9,44} kilogramów.
...
w eksperymencie (\text{9,44} vs \text{9,14}).

Zauważmy też, że wartość najniższej średniej wyniosła \text{76} kilogramów zaś najwyższej \text{131} kilogramów.
Gdybyśmy mieli pecha i wylosowali te skrajnie nieprawdziwe wartości to mylimy się
o \text{26,97} kilogramów
na minus lub \text{28,03} kilogramów na plus.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    89,9    99,6   102,6   102,6   105,6   123,0
\end{verbatim}

Średnia ma wartość \text{102,62} kilogramów, a odchylenie standardowe
\text{4,22} kilogramów.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    96,5   101,5   102,9   102,9   104,3   109,4
\end{verbatim}

Średnia jest równa \text{102,86} kilogramów, a odchylenie standardowe \text{2,06} kilogramów.
Wartość \(s/\sqrt{40}\) jest równa \text{2,04}.

Zauważmy też, że wartość najniższej średniej wyniosła \text{96,5} kilogramów zaś najwyższej \text{109,425} kilogramów.
Gdybyśmy mieli pecha i wylosowali te skrajnie nieprawdziwe wartości to mylimy się o \text{6,36} kilogramów
na minus lub \text{6,57} kilogramów na plus. Niewątpliwie wynik znacznie lepszy niż dla próby
dwuelementowej.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   18,50   39,50   47,00   46,61   54,00   74,00
\end{verbatim}

Średnia średnich z próby ma wartość \text{46,61} lat.
Odchylenie standardowe wyniosło \text{10,23}.
Wartość \(s/\sqrt{2}\) jest równa \text{10,33}.

Wartość najniższej średniej wyniosła \text{18,5} lat zaś najwyższej \text{74} lat.
Gdybyśmy mieli pecha i wylosowali te skrajnie nieprawdziwe wartości to mylimy się
o \text{28,11} lat
na minus lub \text{27,39} lat na plus.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   30,80   43,10   46,30   46,28   49,40   61,10
\end{verbatim}

Średnia średnich z próby ma wartość \text{46,28} lat.
Odchylenie standardowe wyniosło \text{4,68}.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   39,17   44,75   46,16   46,20   47,62   53,50
\end{verbatim}

Średnia średnich z próby ma wartość \text{46,2} lat.
Odchylenie standardowe wyniosło \text{2,21}.
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   41,11   45,01   46,24   46,24   47,44   51,56
\end{verbatim}

Średnia średnich z próby ma wartość \text{46,24} lat.
Odchylenie standardowe wyniosło \text{1,76}
Wartość \(s/\sqrt{70}\) jest równa \text{1,75}.

Wartość najniższej średniej wyniosła \text{41,11} lat zaś najwyższej \text{51,56} lat.
Gdybyśmy mieli pecha i wylosowali te skrajnie nieprawdziwe wartości to mylimy się
już tylko o \text{5,13} lat
na minus lub \text{5,32} lat na plus.
