...
Wartość p równa `r sprintf("%.4f", p.anova)` świadczy o tym, że nie ma istotnych różnic pomiędzy średnimi, co oznacza,
...
`r sprintf("%.4f", pval)` (różnice są zatem nieistotne; wszystkie rozkłady są identyczne i nie ma zależności).
...
* współczynnik Pearsona: `r sprintf ("%.2f", rpm)`;

* współczynnik Spearmana: `r sprintf ("%.2f", rsm)`.
