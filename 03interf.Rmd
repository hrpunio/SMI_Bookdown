# Łagodne wprowadzenie do wnioskowanie statystycznego {#interference}
...
jest raczej więcej niż pewne, że będzie użyta do mniejszych szwindli.
Jeszcze jeden argument żeby nie traktować
wyników analiz statystycznych jako wiedzy
