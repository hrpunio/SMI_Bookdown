...
Asymetria albo skośność (*skewness*) jest odwrotnością symetrii. Rozkład jest symetryczny
jeżeli jednostki są rozłożone „równomiernie” wokół wartości średniej.
W rozkładzie symetrycznym wartości średniej i mediany są sobie równe.
...
```{r, warning=FALSE, out.width="90.0%"}
