...
:::{.example}
**Absolwenci studiów pielęgniarskich w krajach UE**
...
::: {.example}
**Współczynnik dzietności (kontynuuacja)**:
...
```{r boxplot, out.width="90%", fig.cap = "Wykres pudełkowy"}
knitr::include_graphics("./box-plot-0.jpg")
```
