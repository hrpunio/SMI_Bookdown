...
4. Płeć i staż są skorelowane ze zmianą miejsca pracy.
5. Płeć, staż oraz poziom satysfakcji wpływają na zmianę miejsca pracy.
...
przymuje wartość 1 jeżeli `zzp` jest większe
...
Zmienna `kpw` okazała się nieistotna. Szacujemy model, w którym odejście
