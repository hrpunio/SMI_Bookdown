...
pomiędzy zmiennymi nominalnymi `zamiarOklasa` oraz `staz.klasa` przedstawia rysunek \@(fig:tabeleKrzyzowe).
...
```{r regresjaLogistyczna, out.width=jamovi.screen, fig.cap = "Regresja logistyczna"}
knitr::include_graphics("./regresja_logistyczna.png")
```
